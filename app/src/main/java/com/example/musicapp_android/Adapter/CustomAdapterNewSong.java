...
public class CustomAdapterNewSong extends ArrayAdapter
{

    Context context;
    int layoutItem;
    ArrayList<Song> lsNewSong = new ArrayList<>();

    ArrayList<Artist> lsAllArtists = new ArrayList<>();
    private HashMap<String, String> artistMap;


    public CustomAdapterNewSong(@NonNull Context context, int resource, ArrayList<Song> lsNewSong) {
        super(context, resource, lsNewSong);
        this.context = context;
        this.layoutItem = resource;
        this.lsNewSong = lsNewSong;
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        //Song song = lsNewSong.get(position);
