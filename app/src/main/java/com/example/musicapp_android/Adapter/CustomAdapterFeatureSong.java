...
public class CustomAdapterFeatureSong extends ArrayAdapter
{
    Context context;
    int layoutItem;
    ...
    public CustomAdapterFeatureSong(@NonNull Context context, int layout, ArrayList<Song> lsAllSong) {
...
//        txtArtist.setText(String.valueOf(song.getIdArtist()));
